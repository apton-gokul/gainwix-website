  ...
  return (
    <div className="xs:px-5 md:layout text-white bg-[#060A22]">
      ...
      <div className="w-full lg:h-20 flex-center xs:flex-col xs:h-40 gradient-border font-Inter font-medium text-[#908EB5] xs:text-[3.5vw] md:text-[2vw] lg:text-[1vw]">
        &copy; GainWix {new Date().getFullYear()}, All Rights Reserved
      ...
      <div className="w-full flex-center xs:flex-col gradient-border font-Inter font-medium text-[#908EB5] xs:text-[4vw] s:text-[2.5vw] sm:text-[2vw] lg:text-[1vw] py-5">
        &copy; GainWix {new Date().getFullYear()}, All Rights Reserved
